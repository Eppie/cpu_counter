...
std::uint64_t UncontendedAtomicCas(DemoEnvironment &state);
std::uint64_t ContendedAtomicCas(DemoEnvironment &state);
std::uint64_t BarrierLoop(DemoEnvironment &state);
std::uint64_t InterruptStorm(DemoEnvironment &state);
std::uint64_t PageStrideRead(DemoEnvironment &state);
std::uint64_t NtStreamRead(DemoEnvironment &state);
std::uint64_t NtStreamWrite(DemoEnvironment &state);
std::uint64_t FirstTouchFault(DemoEnvironment &state);
std::uint64_t AlignedX64Load(DemoEnvironment &state);
std::uint64_t CrossX64Load(DemoEnvironment &state);
std::uint64_t AlignedPageLoad(DemoEnvironment &state);
std::uint64_t CrossPageLoad(DemoEnvironment &state);
std::uint64_t AlignedX64Store(DemoEnvironment &state);
...
std::uint64_t StoreOrderFriendly(DemoEnvironment &state);
